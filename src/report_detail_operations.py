    ...
    def export_to_pdf_colored(self, flag):
        ...
        for row_index in range(1, num_rows):
            for col_index in range(num_cols):
                ...
                try:
                    if col_index < 15 and cell_value != "404.0" and float(cell_value) < settings.DESIRED_TEMP:
                        table_style.add('BACKGROUND', (col_index, row_index), (col_index, row_index), colors.red)
                except ValueError:
                    pass
